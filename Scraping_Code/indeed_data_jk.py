...
def scrape_data(num_pages_to_scrape):
    ...
    try:
        ...
        with open('Indeed-jobs_with_description.csv', mode='w', newline='', encoding='UTF-8') as file:
            ...
            for url_1 in job_description_urls:
                ...
                writer.writerow([job_title, company, location, whole_text])
...
scrape_data(num_pages_to_scrape=5)
